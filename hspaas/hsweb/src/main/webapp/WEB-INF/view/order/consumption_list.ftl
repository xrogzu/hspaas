	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tbody>
			...
			<tr>
				...
				<td>${(p.orderNo)!}</td>
				<td><#if p.invoiceFlag==false>无<#elseif p.invoiceFlag==true><a href="javascript:invoiceList(${(p.id)!})">有</a></#if></td>
			...
			<#else>
			<tr>
				<td colspan="4" style="color:#F00;text-align:center;">暂无消费记录！</td>
			</tr>
			</#if>
		</tbody>
	</table>
