...
<title>华时融合平台管理中心 -财务管理-账户充值</title>
		...
		<div class="main">
			<div class="breadcrumbs">
				<ul>
					...
					<li class="active"><a href="${rc.contextPath}/account/recharge">在线充值</a></li>
				</ul>
			</div>
			...
			<div class="recharge_form">
              <form method="post" id="order_form">
                <dl>
                  ...
                  <dd>
                      <span><label>
                      		<input name="productFee" type="text" placeholder="请输入充值金额" value="500" id="tc1">
                      </label></span>&nbsp;元
                      <span id="tc1Tip"></tip>
                  </dd>
                </dl><br/>
                 <dl>
                  ...
                  <dd class="type" id="offline_bank" style="display:none;">
                  		<hr/>
	                 	账户名称：杭州华时科技信息技术有限公司<br/>
	                 	银行账号：6227182222222213<br/>
	                 	开户银行：武林支行
	                 	<hr/>
                  </dd>
...
$(function(){
	...
	function validate(){
 	  errTip();
 	  if($("#tc1").val()==null || $("#tc1").val()==undefined || $("#tc1").val()==""){
			$('#tc1Tip').html("<span class='onError'>请输入充值金额！</span>");
			$('#tc1Tip').show();
			return false;
	  }
	  /**
	  if(!/^[0-9]*$/.test($("#tc1").val())){
        	$('#tc1Tip').html("<span class='onError'>请输入正确的充值金额！</span>");
			$('#tc1Tip').show();
			return false;
      }
      */
