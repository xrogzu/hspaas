...
<title>华时融合平台管理中心-系统管理-修改地址</title>
...
<div class="content">
	...
	<div class="main">
		...
		<input type="hidden" name="isDefault" id="isDefaults" value="${(addressBook.isDefault)!}">
		<input type="hidden" name="id" id="id" value="${(addressBook.id)!}">
				...
				<div class="edit_ctn">
					<div class="edit_field">
						<dl>
							...
							<dd><input type="text" id="name" placeholder="请输入姓名" maxlength="10" value="${(addressBook.name)!}" name="name" style="width: 215px;">
					...
					<div class="edit_field">
						<dl>
							...
							<dd><input type="text" id="mobile" placeholder="请输入手机号码" maxlength="11" value="${(addressBook.mobile)!}" name="mobile" style="width: 215px;">
					...
					<div class="edit_field">
						<dl>
							...
							<dd><input type="text" id="address" class="address" placeholder="请输入地址" value="${(addressBook.address)!}"  name="address">
					...
					<div class="edit_field">
						<dl>
							<dt>邮编</dt>
							<dd><input type="text" id="zipCode" placeholder="请输入邮编" maxlength="7" value="${(addressBook.zipCode)!}" name="zipCode" style="width: 215px;">
					...
					<div class="edit_field">
						<dl>
							<dt>是否默认</dt>
							<dd><input type="checkbox" id="isDefault" onclick="checkStatus()" style="margin-top:13px;" <#if addressBook.isDefault==1>checked</#if>>
...
<script>
new PCAS("province","city","area","${(addressBook.province)!}","${(addressBook.city)!}","${(addressBook.area)!}");
	$(function(){
		...
		$.formValidator.initConfig({formID:"myForm", submitOnce : true, onSuccess:function(){
			$.ajax({
				url : "${rc.contextPath}/settings/address_book/update",
				dataType:"json",
