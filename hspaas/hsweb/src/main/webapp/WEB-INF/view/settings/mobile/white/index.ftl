...
<div class="content">
	...
	<div class="main">
		...
		<form id="list_form" action="${rc.contextPath}/settings/mobile/white/list">
...
<script>
	function remove(id){
		if (confirm("确认要删除？")) {
			$.ajax({
				url : "${rc.contextPath}/settings/mobile/white/delete",
				dataType:"json",
				data:{
					id:id
				},
	...
	function back_jump(){
		location.href = "${rc.contextPath}/settings/mobile/white/create";
	}
</script>
</html>