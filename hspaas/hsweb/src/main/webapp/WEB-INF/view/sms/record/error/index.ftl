...
$(function(){
	...
	loadMenu('li_dx','dx_send','dx_send_error');
});
</script>
</head>
<body>
	...
	<div class="main">
		<div class="breadcrumbs">
			<ul>
                ...
                <li class="active"><a href="${rc.contextPath}/sms/record/error/index">失败记录</a></li>
			</ul>
		</div>
		<form id="list_form" action="${rc.contextPath}/sms/record/error/list">
