...
$(function(){
	...
	loadMenu('li_liuliang','flow','my_order');
});
</script>
</head>
<body>
	...
	<div class="main">
		<div class="breadcrumbs">
			<ul>
                ...
                <li class="active"><a href="${rc.contextPath}/fs/record/order/index">我的订单</a></li>
			</ul>
		</div>
		<form id="list_form" action="${rc.contextPath}/fs/record/order/list">
